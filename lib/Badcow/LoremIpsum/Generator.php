...
class Generator
{
    ...
    /**
     * @param null|int $wordsPerParagraph
     * @param null|float $wordPerSentence
     */
    public function __construct($wordsPerParagraph = null, $wordPerSentence = null)
	{
		if (null !== $wordsPerParagraph) {
            $this->wordsPerParagraph = $wordsPerParagraph;
        }

        if (null !== $wordPerSentence) {
            $this->wordsPerSentence = $wordPerSentence;
        }
	}
